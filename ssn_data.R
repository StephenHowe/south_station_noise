...
df12 <- read.delim("data/20200228_to_20200302.txt", sep ="\t", stringsAsFactors = FALSE)
df13 <- read.delim("data/20200302_to_20200304.txt", sep ="\t", stringsAsFactors = FALSE)
df14 <- read.delim("data/20200304_to_20200306.txt", sep ="\t", stringsAsFactors = FALSE)
df15 <- read.delim("data/20200306_to_20200310.txt", sep ="\t", stringsAsFactors = FALSE)
df16 <- read.delim("data/20200310_to_current.txt", sep ="\t", stringsAsFactors = FALSE)
df <- rbind(df1, df2, df3, df4, df5, df6, df7, df8, df9, df10, df11, df12, df13, df14, df15, df16)
